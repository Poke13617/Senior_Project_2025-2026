...
def class(): # This will be used to get the classes to use in-game (1998 is a dev character)
...
def enemy_outcome(): # dev enemy with 1998 modifier, not a killable boss, but a survival enemy
    ...
    enemy_distance = 150
    return enemy_name
    return enemy_distance_closing
    return enemy_attacks
    return enemy_damages
